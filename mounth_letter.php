      ...
      foreach ($results as $key ) {
        ...
        if($filesize >19)
        {
          //Generate a random string.
            ...
            copy($mydir.''.$key,'audio/'.$mounth[$i].'/'.$day[$i].'/'.$output_name.'_high.mp3');
          ...
          echo $mydir.''.$key,'audio/'.$mounth[$i].'/'.$day[$i].'/'.$output_name.'.mp3';
