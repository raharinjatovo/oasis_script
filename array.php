    ...
    "message": {
      "attachment": {
        ...
        "payload": {
          ...
          "elements": [{
            "title": "Fandaharana",
            "subtitle": "Ireo Fandaharana rehetra ,tsindrio ny bokotra eo ambany 👇👇👇👇👇",
            "item_url": "http://www.adventistfmc.mg/",
            "image_url":  "'.self::IMAGE.'",
            "buttons": [{
              "type": "postback",
            ...
            "title": "Mediasion",
            "subtitle": "Misy ireo vokatry ny tarika ,tsindrio ny bokotra eo ambany 👇👇👇👇👇",
            "item_url": "http://www.adventistfmc.mg/",
            "image_url":  "'.self::IMAGE.'",
            "buttons": [ {
              "type": "postback",
          ...
          {
            "title": "Circulaire",
            "subtitle": "Fandefasana filazan-draharaha ,tsindrio ny bokotra eo ambany 👇👇👇👇👇,tsindrio ny bokotra eo ambany 👇👇👇👇👇",
            "item_url": "http://www.adventistfmc.mg/",
            "image_url":  "'.self::IMAGE.'",
            "buttons": [ {
              "type": "postback",
  ...
  public function get_firstname($recipient)
 {
        ...
        if (file_exists('audio'.$data.''.$key1->file)) {
          if ($num%10==0) {
            array_push($array,'
               {
                "title": "'. $key1->name.'",
                "subtitle": "Tsindrio ny bokotra etsy ambany 👇👇👇👇👇",
  ...
  public function audio_emission($recipient,$payload)
  {
    ...
    if (file_exists('audio'.$data.''.$payload)) {
       ...
       $this->sendAudio_quickreply($recipient,'https://www.prodns.xyz/mbola/oasis/audio'.$data.''.$payload);
    }
    else{
        $this->sendTextMessage($recipient,'tsy mandeha androany io fandaharana io \n Azafady, tsindrio ny bokotra fandaharana ahitanao ireo fandaharana androany');
